...
/* Each card image has a sibling <name>-thumb.webp (320 px wide) generated by
 * scripts/build_thumbnails.py. Used for the grid srcset. */
export function thumbSrc(img) {
  return img.replace(/\.webp$/, "-thumb.webp");
}
